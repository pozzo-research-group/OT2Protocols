class OuzoSample:
    ...
    def source_aq(self,dict_to_source, prestock):
        '''
        Update dictionary that tracks paremeters associated with this component 
        ...
        stock_solvent_mass = total_stock_mass-component_mass

        dict_to_source['total_stock_mass']=total_stock_mass
        dict_to_source['stock_solvent_mass']=stock_solvent_mass
        if prestock == True:
            dict_to_source['aq_prestock'] = self.make_aq_prestock(dict_to_source)
        else:
            self.additional_water_mass -= stock_solvent_mass
    ...
    def source_organic(self, dict_to_source):
        ...
        self.additional_organic_solvent_mass -= stock_solvent_mass
        return 
    ...
    def make_aq_prestock(self, dict_for_prestock):
        ...
        prestock_component_wtf = min_component_mass/(sum([self.water_mass,min_component_mass]))
        ...
        #How much of master stock is necessary to make this prestock:
        total_stock_mass  = prestock_component_mass/component_stock.componentA_wtf
        stock_solvent_mass = total_stock_mass-prestock_component_mass
        additional_solvent_mass = scaled_prestock_mass-stock_solvent_mass-prestock_component_mass

        total_stock_volume = total_stock_mass/component_stock.density
        additional_solvent_volume = additional_solvent_mass/component_stock.solvent1.density
