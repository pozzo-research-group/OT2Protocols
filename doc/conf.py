...
# -*- coding: utf-8 -*-
#
# ot2protocol documentation build configuration file, created by
...
htmlhelp_basename = 'ot2protocoldoc'
...
latex_documents = [
  ('index', 'ot2protocol.tex', 'ot2protocol Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'ot2protocol', 'ot2protocol Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'ot2protocol', 'ot2protocol Documentation',
   'Ariel Rokem', 'ot2protocol', 'One line description of project.',
   'Miscellaneous'),
]
